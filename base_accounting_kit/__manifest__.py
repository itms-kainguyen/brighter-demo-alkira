...

{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'base_accounting_kit/static/lib_itms/bootstrap-toggle-master/css/bootstrap-toggle.min.css',
            'base_accounting_kit/static/src/js/account_dashboard.js',
            'base_accounting_kit/static/src/js/account_asset.js',
            'base_accounting_kit/static/lib_itms/Chart.bundle.js',
            'base_accounting_kit/static/lib_itms/Chart.bundle.min.js',
            'base_accounting_kit/static/lib_itms/Chart.min.js',
            'base_accounting_kit/static/lib_itms/Chart.js',
            'base_accounting_kit/static/lib_itms/bootstrap-toggle-master/js/bootstrap-toggle.min.js',
