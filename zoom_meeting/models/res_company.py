...
class ResCompany(models.Model):
    ...
    def _compute_token_page_url(self):
        for page in self:
            page.account_token_page_url = request.httprequest.host_url+"web#id="+str(page.id)+"&action="+str(
                page.env.ref("base.action_res_company_form").id)+"&model=res.company&view_type=form"
    ...
    def refresh_access_token(self):
        if self.refresh_token:
            ...
            resp = requests.post('https://zoom.us/oauth/token', data=data, auth=(
            ...
            if resp.get('access_token'):
                ...
                return self.env['wk.wizard.message'].genrated_message("Token has been expired, please regenerate to it...", name='Message')