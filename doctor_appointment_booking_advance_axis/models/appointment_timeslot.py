...
class appointment_timeslot(models.Model):
    _name = 'appointment.timeslot'
    _description = 'appointment_timeslot'

    name = fields.Char(string='Name')
    day = fields.Selection([('sunday', 'Sunday'), ('monday', 'Monday'), ('tuesday', 'Tuesday'), ('wednesday', 'Wednesday'), ('thursday', 'Thursday'), ('friday', 'Friday'), ('saturday', 'Saturday')], required=True)
